...
contract PolyERC721UC is UniversalChanIbcApp, ERC721 {
    ...
    constructor(address _middleware) UniversalChanIbcApp(_middleware) ERC721("PolymerFarcaster", "POLYCAST") {}
    ...
    function crossChainMint(address destPortAddr, bytes32 channelId, uint64 timeoutSeconds)
        external
    {
        ...
        returns (AckPacket memory ackPacket)
    {
        ...
        (address _caller) = abi.decode(packet.appData, (address));

        uint256 tokenId = mint(_caller);
